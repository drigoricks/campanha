...
import br.com.programa.campanha.mock.CampanhaRequestMock;
...
public class CampanhaRestTest {
    ...
    public void deveIncluirCampanhaComSucesso() {
    	Campanha campanhaRequest = CampanhaRequestMock.getCampanhaRequest();
    ...
    public void deveRetornarHttp400AoIncluirCampanhaComCodigoTimeCoracaoNulo() {
    		Campanha campanhaRequest = CampanhaRequestMock.getCampanhaRequest();
        campanhaRequest.setIdTimeCoracao(null);
